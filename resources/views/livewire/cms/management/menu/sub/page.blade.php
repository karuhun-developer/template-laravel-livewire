...
new class extends BaseComponent {
    ...
    public function mount() {
        ...
        $this->title = 'Sub Menu of ' . $this->menu->name;
        $this->description = 'Manage sub menus for ' . $this->menu->name;
    ...
    public function with() {
        ...
        $model = (new $this->modelInstance)->query()
            ->join('roles', 'roles.id', '=', 'menu_subs.role_id')
        ...
        if ($this->whereRoleId) {
            $model->where('menusubs.role_id', $this->whereRoleId);
        }
    ...
    public function delete($id) {
        ...
        MenuSub::findOrFail($id)->delete();

        $this->dispatch('alert', type: 'success', message: 'Sub Menu deleted successfully.');
    }
}; ?>
                    ...
                    <div class="d-lg-flex">
                        ...
                        <div class="ms-auto my-auto mt-lg-0">
                            <div class="ms-auto my-auto">
                                <x-cms.action.create-btn :$modelInstance :link="route('cms.management.menu.sub.create', [
                                    'menu' => $menu->id,
                                ])">
                                    +&nbsp; New Sub Menu
                                ...
                                @forelse ($data as $d)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <x-cms.action.update-btn :$modelInstance :link="route('cms.management.menu.sub.edit', [
                                                'menu' => $menu->id,
                                                'model' => $d->id,
                                            ])">
